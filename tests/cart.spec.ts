...
test.describe('Cart', () => {
  ...
  test(
    'empty cart shows no items and blank total',
    { tag: '@regression' },
  ...
  test(
    'cart displays full list when multiple products are added',
    { tag: '@regression' },
  ...
  test(
    'total reflects all added items',
    { tag: '@regression' },
    async ({ cartWithTwoProducts }) => {
      const {
        page,
  ...
  test(
    'deleting an item updates the cart correctly',
    { tag: '@regression' },
    async ({ cartWithTwoProducts }) => {
      const {
        page,
  ...
  test(
    'cart state is preserved after interrupting the purchase flow',
    { tag: '@regression' },
    async ({ cartWithOneProduct }) => {
      const { page, name: expectedName, price: expectedPrice } = cartWithOneProduct;
      const cartPage = new CartPage(page);
  ...
  test(
    'adding the same product twice results in two rows',
    { tag: '@regression' },
    async ({ cartWithOneProduct }) => {
